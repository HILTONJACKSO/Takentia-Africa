...
function NewRevenueContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post(`http://localhost:8001/api/v1/operations/revenues?company_id=${targetCompanyId}`, payload, {
                headers: { Authorization: `Bearer ${token}` }
            });

            router.push(`/dashboard/operations/revenues?company_id=${targetCompanyId}`);
        } catch (err: any) {
            let errorMessage = "Failed to record revenue.";
            ...
            <div className="row justify-content-center">
                <div className="col-12 col-lg-8">
                    ...
                    <div className="card border-0 shadow-sm rounded-4 p-4 p-md-5">
                        <div className="mb-5">
                            <h2 className="fw-bolder mb-1">Record New Revenue</h2>
                            <p className="text-secondary small fw-medium">Log a new income stream for this company</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="row g-4">
                                <div className="col-12 col-md-6">
                                    <label className="form-label text-secondary fw-bold small text-uppercase">Revenue Source</label>
                                    <input
                                        type="text"
                                        className="form-control form-control-lg bg-light border-0 rounded-3 shadow-none fw-medium"
                                        placeholder="e.g. Service Fee, Sales"
